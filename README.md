...
// Задать скважность ШИМ значением из реально доступного диапазона для выбраной разрядности или частоты ШИМ
// pin: 9 или 10
// duty: значение из реально доступного диапазона для выбраной разрядности или частоты ШИМ
